...
if($result) {
    while($row = mysqli_fetch_assoc($result)) {
       ...
       $statusButton = ($status == 0) ?
           '<button class="but btn-success">Active</button>' :
           '<button class="but btn-danger">Block</button>';

        $adminButton = ($status == 1) ?
            '<button class="but btn-success">admin</button>' :
            '<button class="but btn-danger">user</button>';
        ...
        echo '<tr>
            ...
            <td>'.$password.'</td>
            <td>'.$role.'</td>
            <td><a href="../statusupdate.php?'.$id.'">'.$statusButton.'</a></td>
            <td><a href="../adminStatus.php?'.$id.'">'.$adminButton.'</a></td>
            <td class="dl">
                <button class="but"><a href="../delete.php?'.$id.'">Delete</a></button>
            </td>
        </tr>';
    }
}
