...
<body>
    ...
    <!-- <div class="container"> -->
        <div class="back12">
    <h1 style="text-align: center; color: #e99124;">Register</h1>
    <div class="acer"><a href="index.html">Home</a> > <a href="#">Create Account</a></div>
    <div class="container">
    ...
    <form action="signupform.php" method="post">
        ...
        <div class="form-row" style="width:50% ;">
          ...
          <div class="form-row"style="width:50% ;">
            <div class="col">
            <input type="text" class="form-control" placeholder="Password" name="passward">
          </div></div><br>
        <p style="font-size:15px ;">Sign up for early Sale access pls tilored new arrivals,treads promotions.<br> To opy out,click unsubscribe in our emails.<br></p>
        <button class="btn-primary" style="width: 50%;border: none; height: 40px; border-radius:10px ;" >Register</button><br><br>
        <button class="btn-danger" style="width: 50%; border: none; height: 40px; border-radius:10px ;">Login</button><br><br>
